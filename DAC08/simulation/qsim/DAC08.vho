...
-- Design Ports Information
-- piz	=>  Location: PIN_AB2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\piz~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
-- Equation(s):
-- \inst1|cnt[1]~10_combout\ = (\inst1|u_d~combout\ & ((\inst1|cnt\(1) & (!\inst1|cnt[0]~9\)) # (!\inst1|cnt\(1) & ((\inst1|cnt[0]~9\) # (GND))))) # (!\inst1|u_d~combout\ & ((\inst1|cnt\(1) & (\inst1|cnt[0]~9\ & VCC)) # (!\inst1|cnt\(1) & 
-- (!\inst1|cnt[0]~9\))))
-- \inst1|cnt[1]~11\ = CARRY((\inst1|u_d~combout\ & ((!\inst1|cnt[0]~9\) # (!\inst1|cnt\(1)))) # (!\inst1|u_d~combout\ & (!\inst1|cnt\(1) & !\inst1|cnt[0]~9\)))
...
-- Equation(s):
-- \inst1|cnt[2]~12_combout\ = ((\inst1|u_d~combout\ $ (\inst1|cnt\(2) $ (\inst1|cnt[1]~11\)))) # (GND)
-- \inst1|cnt[2]~13\ = CARRY((\inst1|u_d~combout\ & (\inst1|cnt\(2) & !\inst1|cnt[1]~11\)) # (!\inst1|u_d~combout\ & ((\inst1|cnt\(2)) # (!\inst1|cnt[1]~11\))))
...
-- Equation(s):
-- \inst1|comb~1_combout\ = (!\inst1|cnt\(2) & (!\inst1|cnt\(1) & (!\inst1|cnt\(3) & !\inst1|cnt\(0))))
...
-- Equation(s):
-- \inst1|cnt[4]~16_combout\ = ((\inst1|cnt\(4) $ (\inst1|u_d~combout\ $ (\inst1|cnt[3]~15\)))) # (GND)
-- \inst1|cnt[4]~17\ = CARRY((\inst1|cnt\(4) & ((!\inst1|cnt[3]~15\) # (!\inst1|u_d~combout\))) # (!\inst1|cnt\(4) & (!\inst1|u_d~combout\ & !\inst1|cnt[3]~15\)))
...
-- Equation(s):
-- \inst1|cnt[6]~20_combout\ = ((\inst1|cnt\(6) $ (\inst1|u_d~combout\ $ (\inst1|cnt[5]~19\)))) # (GND)
-- \inst1|cnt[6]~21\ = CARRY((\inst1|cnt\(6) & ((!\inst1|cnt[5]~19\) # (!\inst1|u_d~combout\))) # (!\inst1|cnt\(6) & (!\inst1|u_d~combout\ & !\inst1|cnt[5]~19\)))
...
-- Equation(s):
-- \inst1|cnt[7]~22_combout\ = \inst1|u_d~combout\ $ (\inst1|cnt[6]~21\ $ (!\inst1|cnt\(7)))
...
-- Equation(s):
-- \inst1|comb~0_combout\ = (!\inst1|cnt\(4) & (!\inst1|cnt\(5) & (!\inst1|cnt\(6) & !\inst1|cnt\(7))))
...
-- Equation(s):
-- \inst1|comb~2_combout\ = (\inst1|comb~1_combout\ & \inst1|comb~0_combout\)
...
-- Equation(s):
-- \inst1|Equal1~0_combout\ = (\inst1|cnt\(4) & (\inst1|cnt\(5) & (\inst1|cnt\(6) & \inst1|cnt\(7))))
...
-- Equation(s):
-- \inst1|Equal1~1_combout\ = (\inst1|cnt\(2) & (\inst1|cnt\(1) & (\inst1|cnt\(3) & \inst1|cnt\(0))))
...
-- Equation(s):
-- \inst1|Equal1~2_combout\ = (\inst1|Equal1~0_combout\ & \inst1|Equal1~1_combout\)
