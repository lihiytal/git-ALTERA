...
-- Equation(s):
-- \inst|LessThan0~0_combout\ = (!\inst|cnt\(3) & (((!\inst|cnt\(0) & !\inst|cnt\(1))) # (!\inst|cnt\(2))))
...
-- Equation(s):
-- \inst|LessThan0~1_combout\ = (((!\inst|cnt\(6)) # (!\inst|cnt\(7))) # (!\inst|cnt\(4))) # (!\inst|cnt\(5))
...
-- Equation(s):
-- \inst1|comb~1_combout\ = (!\inst1|cnt\(0) & (!\inst1|cnt\(2) & (!\inst1|cnt\(1) & !\inst1|cnt\(3))))
...
-- Equation(s):
-- \inst1|Equal1~1_combout\ = (\inst1|cnt\(0) & (\inst1|cnt\(2) & (\inst1|cnt\(1) & \inst1|cnt\(3))))
