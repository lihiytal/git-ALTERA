...
ENTITY 	oc IS
	...
	b_b : IN std_logic;
	clk : IN std_logic;
	octava : OUT STD.STANDARD.integer range 0 TO 8;
	oct : OUT STD.STANDARD.integer range 0 TO 255;
...
ww_b_b <= b_b;
ww_clk <= clk;
octava <= IEEE.STD_LOGIC_ARITH.CONV_INTEGER(UNSIGNED(ww_octava));
oct <= IEEE.STD_LOGIC_ARITH.CONV_INTEGER(UNSIGNED(ww_oct));
